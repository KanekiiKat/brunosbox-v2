...
public class Brunosbox {
        ...
        /**
         * Crea una tarjeta de puntos de boxeo a partir de la tarjeta blanca
         * entregada por el juez blanco.
         */
        ScoreCard whiteScoreCard = new ScoreCard("WHITE");

        /**
         * Asigna el nombre de los pugiles Rocky Balboa (red) vs Apollo Creed
         * (blue)
         */
        ...
        /**
         * Muestra la tarjeta por consola con el formato que se propone en el
